...
This repo contains projects, codes, examples, exercises and results for the book "[AUTOSAR MCAL Embedded Upskilling Bootcamp](https://embedded-house.ghost.io/tag/autosar-mcal-with-nxp-s32k1xx/)" by Modular MX.
...
You can find the [**Setup AUTOSAR Tools**](https://embedded-house.ghost.io/part-0-setup-your-autosar-tools/) section where it is explained by Modular MX the right procedure to download, install and configure all needed tools, including its dependencies, how to import the template project file and flash it to the device.

## Results (In progress)

### Output example from CAN module example:
