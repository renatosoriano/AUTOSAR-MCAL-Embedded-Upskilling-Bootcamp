1. Example Description
    ...
    1.1 The application software functionality
            ...
            - Distribute partition for Mem_Eep backup.
            - Initialize Mem_Eep driver.
            - Erase the whole Mem_Eep space.
            - Write 32 bytes of data to the Mem_Eep.
            - Compare the data was written.
            - Read 32 bytes of data from the Mem_Eep.
            - Check received data.
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.2 Connections
            - There are no specific connections needed
        2.1.3 Debugger
    ...
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - PLUGINS_DIR The path to the Tresos plugins directory
                Ex: PLUGINS_DIR = C:/EB/tresos29.0.0/plugins
...
3. Building the example application
    ...
    3.3 Running the application on the board
        To execute the example application from your command line execute make run. For executing the script in a T32 window already open the paths from run.cmm needs to be changed relative to the debug folder instead of the example root folder.
