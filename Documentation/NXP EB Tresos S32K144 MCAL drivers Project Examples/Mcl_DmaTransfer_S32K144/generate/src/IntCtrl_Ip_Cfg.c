...
#include "Platform_MemMap.h"
    ...
    static const IntCtrl_Ip_IrqConfigType aIrqConfiguration[] = {
        {DMA0_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA1_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA2_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA3_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA4_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA5_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA6_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA7_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA8_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA9_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA10_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA11_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA12_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA13_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA14_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA15_IRQn, (boolean)TRUE, 0U, undefined_handler},
        {DMA_Error_IRQn, (boolean)TRUE, 0U, undefined_handler},
    };
