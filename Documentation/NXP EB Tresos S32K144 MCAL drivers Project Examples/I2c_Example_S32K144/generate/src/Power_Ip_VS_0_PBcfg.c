...
#define POWER_IP_VS_0_PBCFG_SW_MAJOR_VERSION_C               2
...
*
*/
const Power_Ip_ModeConfigType Power_Ip_aModeConfigPB_VS_0[6U] =
{
    ...
    /* Start of Mcu_aModeConfig[3] */
    {
        /* Mode Configuration ID. */
        (Power_Ip_ModeType)3U,
        ...
        /* The Sleep On Exit configuration */
        FALSE,
    }, /* End of Mcu_aModeConfig[3] */
    /* Start of Mcu_aModeConfig[4] */
    {
        /* Mode Configuration ID. */
        (Power_Ip_ModeType)4U,
        ...
        /* The Sleep On Exit configuration */
        FALSE,
    }, /* End of Mcu_aModeConfig[4] */
    /* Start of Mcu_aModeConfig[5] */
    {
        /* Mode Configuration ID. */
        (Power_Ip_ModeType)5U,
