...
static Lpspi_Ip_DeviceParamsType Lpspi_Ip_DeviceParamsCfg_VS_0[2U] =
{
...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Master_VS_0 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Master_VS_0 =
{
    0U,  /* Instance */
    ...
    /*HalfDuplexCfgr1*/
    , LPSPI_CFGR1_OUTCFG(1u) | LPSPI_CFGR1_PINCFG(2u)    
    #endif
    
    ,&Lpspi_Ip_DeviceParamsCfg_VS_0[0U]
};
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Slave_VS_0 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Slave_VS_0 =
{
    1U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(7U) | LPSPI_CCR_PCSSCK(7U) | LPSPI_CCR_SCKDIV(78U) | LPSPI_CCR_DBT(49U)), /* CCR */
        /* Normal Mode TCR */
...
/* The SPI Hw Unit configuration structures */
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_VS_0 =
{
    1U,  /* Instance */
    /* CR */
    (uint32)0,
