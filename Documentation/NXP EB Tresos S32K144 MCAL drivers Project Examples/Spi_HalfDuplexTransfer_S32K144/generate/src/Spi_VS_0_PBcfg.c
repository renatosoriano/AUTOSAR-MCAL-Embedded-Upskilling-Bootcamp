...
static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_1;
/* Allocate Buffers for IB Channels (if any) */
...
/* Channel Configuration of SpiChannel_1*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_1_VS_0 =
{
        /* SpiChannel_1*/
        EB, /* BufferType IB or EB */
        8U, /* Frame size */
        ...
        (uint32)1U, /* In the case SpiDefaultData is disabled. Set this value is 1U */
        1000U, /* Length (configured in SpiEbMaxLength) */
        &Spi_Buffer_VS_0_SpiChannel_1, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
...
static const Spi_ChannelsCfgType Spi_aChannelConfigList_VS_0[2] =
{
    ...
    /* SpiChannel_1 */
    /* SpiChannel_1 */
    &Spi_ChannelConfig_SpiChannel_1_VS_0
    }
...
static const Spi_ChannelType Spi_SpiJob_1_ChannelAssignment_VS_0[1] = {SpiConf_SpiChannel_SpiChannel_1};
...
static const Spi_JobConfigType Spi_JobConfig_SpiJob_0_VS_0 =
{
        ...
        SPI_SpiExternalDevice_Master, /* External Device */
                &Spi_aExternalDeviceConfigList_VS_0[SPI_SpiExternalDevice_Master] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
...
static const Spi_JobConfigType Spi_JobConfig_SpiJob_1_VS_0 =
{
        ...
        CSIB1, /* HWUnit index */
        /* External Device Settings */
        SPI_SpiExternalDevice_Slave, /* External Device */
                &Spi_aExternalDeviceConfigList_VS_0[SPI_SpiExternalDevice_Slave] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
