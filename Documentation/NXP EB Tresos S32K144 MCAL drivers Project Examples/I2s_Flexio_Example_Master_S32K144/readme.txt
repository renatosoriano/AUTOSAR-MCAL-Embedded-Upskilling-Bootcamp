1. Example Description
		...
		- I2s_Flexio_to_Flexio_Example_Master_S32K144 must run on S32K144 board.(current example)
		- I2s_Flexio_to_Flexio_Example_Slave_S32M244 must run on S32M244 board. (additional example)
    ...
    1.1 The application software functionality
        ...
        - I2s_AsyncTransmit
            Starts an asynchronous transmission on the Flexio_I2s bus.
            Sends the data from master to slave and receive back data from slave.
...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
			...
			- XS32M2XXCVB-Q064 PCB 53099 RevX1 SCH RevA - Additional board needed to run on the slave example. 
        2.1.2 Connections
            The connections must be done on two boards as following:
			
			MASTER S32K144			 	SLAVE S32M244
