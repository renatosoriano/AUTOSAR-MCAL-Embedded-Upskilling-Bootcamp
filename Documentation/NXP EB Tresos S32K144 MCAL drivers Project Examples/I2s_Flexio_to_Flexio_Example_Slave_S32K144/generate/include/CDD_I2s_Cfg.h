...
#define I2S_CFG_SW_MAJOR_VERSION                2
...
#if (I2S_CFG_VENDOR_ID != I2S_VS_0_PBCFG_VENDOR_ID)
#error "CDD_I2s_Cfg.h and CDD_I2s_VS_0_PBcfg.h have different vendor IDs"
#endif

/* Check if current file and CDD_I2s_VS_0_PBcfg header file are of the same Autosar version */
#if ((I2S_CFG_AR_RELEASE_MAJOR_VERSION     != I2S_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (I2S_CFG_AR_RELEASE_MINOR_VERSION     != I2S_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (I2S_CFG_AR_RELEASE_REVISION_VERSION  != I2S_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of CDD_I2s_Cfg.h and CDD_I2s_VS_0_PBcfg.h are different"
#endif

/* Check if current file and CDD_I2s_VS_0_PBcfg header file are of the same software version */
#if ((I2S_CFG_SW_MAJOR_VERSION != I2S_VS_0_PBCFG_SW_MAJOR_VERSION) || \
     (I2S_CFG_SW_MINOR_VERSION != I2S_VS_0_PBCFG_SW_MINOR_VERSION) || \
     (I2S_CFG_SW_PATCH_VERSION != I2S_VS_0_PBCFG_SW_PATCH_VERSION))
#error "Software Version Numbers of CDD_I2s_Cfg.h and CDD_I2s_VS_0_PBcfg.h are different"
#endif
