...
*
*/
#define PortConf_PortPin_PortPin_FXIO_D5_Tx  0
#define PortConf_PortPin_PortPin_FXIO_D1_Rx  1
#define PortConf_PortPin_PortPin_FXIO_D6_Sck  2
#define PortConf_PortPin_PortPin_FXIO_D7_Sync  3
