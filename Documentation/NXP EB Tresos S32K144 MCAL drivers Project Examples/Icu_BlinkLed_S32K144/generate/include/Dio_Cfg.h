...
/**
* @brief          Symbolic name for the channel Port_pin_InputForIcuChannel0.
*
*/
#define  DioConf_DioChannel_Port_pin_InputForIcuChannel0 ((uint16)0x0042U)
...
/**
* @brief          Symbolic name for the channel Digital_Output_LED_RED.
*
*/
#define  DioConf_DioChannel_Digital_Output_LED_RED ((uint16)0x006fU)



/**
* @brief          Symbolic name for the channel Digital_Output_LED_GREEN.
*
*/
#define  DioConf_DioChannel_Digital_Output_LED_GREEN ((uint16)0x0070U)
...
/**
* @brief          Symbolic name for the channel Port_pin_InputForIcuChannel1.
*
*/
#define  DioConf_DioChannel_Port_pin_InputForIcuChannel1 ((uint16)0x0088U)
