...
*
*/
#define PortConf_PortPin_FTM_0_CH_1  0
#define PortConf_PortPin_Port_pin_InputForIcuChannel0  1
#define PortConf_PortPin_Digital_Output_LED_RED  2
#define PortConf_PortPin_Port_Ci_3_CH_0  3
#define PortConf_PortPin_Port_pin_InputForIcuChannel1  4
#define PortConf_PortPin_Digital_Output_LED_GREEN  5
