...
#define DMA_IP_NOF_CFG_LOGIC_CHANNELS   ((uint32)4U)
...
/* Logic Channel 2 Scatter/Gather Elements */
#define DMA_LOGIC_CH_2_NOF_CFG_SGA_ELEMENTS  ((uint32)1U)

#define DMA_LOGIC_CH_2_SGA_ELEMENT_0       ((uint32)0U)
