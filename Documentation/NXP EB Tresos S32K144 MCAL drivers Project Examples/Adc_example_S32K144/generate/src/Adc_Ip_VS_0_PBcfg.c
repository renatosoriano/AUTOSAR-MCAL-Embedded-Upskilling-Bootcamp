...
*/
static const Adc_Ip_ChanConfigType AdcIpChansConfig_1_VS_0[3U] =
{
    {
        0U, /* ChnIdx */
        ADC_IP_INPUTCHAN_VREFH, /* Channel */
...
/**
* @brief          ADC Ip Config for Logical ID 0 corresponding to the ADC0 configuration variant VS_0.
*/
...
/**
* @brief          ADC Ip Config for Logical ID 1 corresponding to the ADC1 configuration variant VS_0.
*/
