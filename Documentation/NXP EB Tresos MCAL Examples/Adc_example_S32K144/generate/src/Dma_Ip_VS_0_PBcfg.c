...
const Dma_Ip_LogicInstanceConfigType LogicInstance0ConfigPB_VS_0 =
{
    ...
    /* boolean EnHaltAfterError; */        (boolean)TRUE,
    /* boolean EnChLinking; */             (boolean)TRUE,
...
const Dma_Ip_GlobalConfigType LogicChannel1GlobalConfigPB_VS_0 =
{
    ...
    }, /* Swap */
    {
        ...
        /* boolean EnPreemption; */          (boolean)TRUE,
        /* boolean DisPreempt; */            (boolean)TRUE,
    }, /* Priority */
};
...
{
    {
        ...
        /* boolean EnHalfMajorInt; */      (boolean)TRUE,
...
#include "Mcl_MemMap.h"
/* DMA Logic Channel 2 */
__attribute__(( aligned(32) )) Dma_Ip_SwTcdRegType LogicChannel2Stcd0PB_VS_0;
...
#include "Mcl_MemMap.h"
/* DMA Logic Channel 2 */
extern Dma_Ip_ScatterGatherConfigType LogicChannel2SgaElem0ConfigPB_VS_0;

/* DMA Logic Channel 2 */

Dma_Ip_TransferConfigType LogicChannel2TransferElem0PB_VS_0 =
{
    {
        /* uint32 ScatterGatherAddr; */    0U,
        /* uint32 DestinationStoreAddr; */ 0U,
...
Dma_Ip_ScatterGatherConfigType LogicChannel2SgaElem0ConfigPB_VS_0 =
{
    /* Dma_Ip_TransferConfigType * TransferConfig */          &LogicChannel2TransferElem0PB_VS_0,
    /* Dma_Ip_SwTcdRegType * Stcd */                          &LogicChannel2Stcd0PB_VS_0,
    /* boolean Loaded; */                                     (boolean)FALSE,
    /* struct Dma_Ip_ScatterGatherConfigType * NextConfig */  NULL_PTR,
};

Dma_Ip_ScatterGatherConfigType * LogicChannel2SgaArrayPB_VS_0[DMA_LOGIC_CH_2_NOF_CFG_SGA_ELEMENTS] =
{
    &LogicChannel2SgaElem0ConfigPB_VS_0,
};
...
Dma_Ip_HwChannelStateType HwChannel3StatePB_VS_0;
...
*
*/
#define DMA_IP_NOF_VIRTUAL_MEMORY_SECTION_VS_0  1U

const Dma_Ip_VirtualSectionConfigType Dma_Ip_VirtualMemorySectionConfig_VS_0[DMA_IP_NOF_VIRTUAL_MEMORY_SECTION_VS_0] =
{
    {
        /* const uint32 VirtualAddrStart; */    0x00000000U,
        /* const uint32 VirtualAddrEnd; */      0x000000ffU,
        /* const uint32 PhysicalAddrStart; */   0x00000000U,
        /* const uint32 PhysicalAddrEnd; */     0x000000ffU,
    },
};
const Dma_Ip_VirtualMemoryConfigType Dma_Ip_VirtualMemoryConfig_VS_0 =
{
    /* const uint8 NumOfSection; */                                           1U,
    /* const Dma_Ip_VirtualSectionConfigType (* const pSectionConfig)[] */    &Dma_Ip_VirtualMemorySectionConfig_VS_0,
};
...
{
    {
        ...
        /* Dma_Ip_Callback IntCallback; */    Adc_Ipw_Adc1DmaTransferCompleteNotification,
        /* Dma_Ip_Callback ErrIntCallback; */ NULL_PTR,
    },  /* Dma_Ip_LogicChannelIdType */
...
const Dma_Ip_LogicChannelConfigType LogicChannel2ConfigPB_VS_0 =
{
    ...
    NULL_PTR,
    NULL_PTR,
    (Dma_Ip_ScatterGatherConfigType**)&LogicChannel2SgaArrayPB_VS_0[0U],
};
const Dma_Ip_LogicChannelConfigType LogicChannel3ConfigPB_VS_0 =
{
    {
...
const Dma_Ip_InitType Dma_Ip_xDmaInitPB_VS_0 =
{
    ...
    /* const Dma_Ip_VirtualMemoryConfigType * const pxVirtualMemoryConfig  */  &Dma_Ip_VirtualMemoryConfig_VS_0,
};
