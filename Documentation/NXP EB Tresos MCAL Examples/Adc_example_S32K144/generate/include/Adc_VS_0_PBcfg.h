...
#define ADC_CFGSET_VS_0_GROUP_1_CHANNELS      (3U)
#define ADC_CFGSET_VS_0_GROUP_2_CHANNELS      (3U)
#define ADC_CFGSET_VS_0_GROUP_3_CHANNELS      (3U)

/**
* @brief          Total number of groups in Config.
*
*/
#define ADC_GROUPS_VS_0                       (4U)
