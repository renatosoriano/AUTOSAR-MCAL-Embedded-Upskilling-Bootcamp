...
/** @brief      Flexio 0 Channel 0 used by PWM */
#ifndef FLEXIO_0_CH_0_USED
    #define FLEXIO_0_CH_0_USED
#else
    #error "Flexio 0 Channel 0 cannot be used by Pwm. Channel locked by another driver!"
#endif

/** @brief      Flexio 0 Pin 0 used by PWM */
#ifndef FLEXIO_0_PIN_0_USED
    #define FLEXIO_0_PIN_0_USED
#else
    #error "Flexio 0 Pin 0 cannot be used by Pwm. Pin used by another driver!"
#endif


/** @brief        Flexio 0 Channel 0 IRQ used by PWM */
#ifdef FLEXIO_0_CH_0_USED
    #define PWM_CHANNEL_0_USED
#else
    #error "Flexio 0 Channel 0 cannot be used by Pwm. Channel locked by another driver!"
#endif

/** @brief      Flexio 0 Pin 0 Mask define for IRQ */
#define FLEXIO_PWM_IP_CHANNEL_0_PINMASK         (1U << 0U)
