...
/* External device Configuration of SpiExternalDevice_Master*/
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_Master_VS_0 =
{
        /* SpiExternalDevice_Master*/
        SPI_OVER_LPSPI, /* IpType */
        0U,  /* Instance */
        
        {   /* ExternalDeviceConfig */
            &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Master_VS_0 /* LPSPI ExternalDeviceConfig */
...
/* External device Configuration of SpiExternalDevice_Slave*/
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_Slave_VS_0 =
{
        /* SpiExternalDevice_Slave*/
        SPI_OVER_LPSPI, /* IpType */
        1U,  /* Instance */
        
        {   /* ExternalDeviceConfig */
            &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Slave_VS_0 /* LPSPI ExternalDeviceConfig */
#if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
            ,NULL_PTR /* Don't have FLEXIO_SPI ExternalDeviceConfig */
#endif
        },
...
const Spi_ExDevicesConfigType Spi_aExternalDeviceConfigList_VS_0[2U] =
{
    {
    /* SpiExternalDevice_Master */
    &Spi_ExternalDeviceConfig_SpiExternalDevice_Master_VS_0
    },
    {
    /* SpiExternalDevice_Slave */
    &Spi_ExternalDeviceConfig_SpiExternalDevice_Slave_VS_0
    }
};
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_1_VS_0 =
{
        ...
        SPI_SPURIOUS_CORE_ID_U32, /* SpiCoreUse */
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_VS_0 /* LPSPI IpConfig */
#if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
            ,NULL_PTR /* Don't have Ipconfig of FLEXIO_SPI */
#endif
            #if ((LPSPI_IP_DMA_USED == STD_ON) && (LPSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
