...
*/
#define MCU_SRAM_RETEN_CONFIG_API    (STD_ON)
...
*/
#define MCU_MAX_MODECONFIGS   ((uint32)6U)
...
#define McuClockSettingConfig_Default   ((Mcu_ClockType)0U)

#define McuConf_McuClockSettingConfig_McuClockSettingConfig_Default   ((Mcu_ClockType)0U)


#define McuClockSettingConfig_0   ((Mcu_ClockType)1U)

#define McuConf_McuClockSettingConfig_McuClockSettingConfig_0   ((Mcu_ClockType)1U)
