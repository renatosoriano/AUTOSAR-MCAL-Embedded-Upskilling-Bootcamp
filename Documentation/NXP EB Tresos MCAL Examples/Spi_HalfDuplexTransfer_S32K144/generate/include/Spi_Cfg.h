...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_Master   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_SpiSequence_Slave   ((Spi_SequenceType)1)
...
*/
#define SPI_SpiExternalDevice_Master  ((Spi_ExternalDeviceType)0u)
#define SPI_SpiExternalDevice_Slave  ((Spi_ExternalDeviceType)1u)
