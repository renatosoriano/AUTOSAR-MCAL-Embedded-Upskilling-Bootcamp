...
*
*/
#define PortConf_PortPin_LPSPI0_SCK  0
#define PortConf_PortPin_LPSPI0_SOUT  1
#define PortConf_PortPin_LPSPI0_PCS0  2
#define PortConf_PortPin_LPSPI1_SCK  3
#define PortConf_PortPin_LPSPI1_SIN  4
#define PortConf_PortPin_LPSPI1_PCS0  5
