...
static Spi_BufferDescriptorType Spi_BufferSpiChannel_1;
/* Allocate Buffers for IB Channels (if any) */
...
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_1 =
{
        ...
        (uint32)1U, /* In the case SpiDefaultData is disabled. Set this value is 1U */
        4U, /* In the case SpiEbMaxLength is disabled. Set this value is 4U */
        &Spi_BufferSpiChannel_1, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
...
static const Spi_ChannelType Spi_SpiJob_1_ChannelAssignment[1] = {SpiConf_SpiChannel_SpiChannel_1};
...
static const Spi_JobType Spi_SpiSequence_0_JobAssignment[2] = {SpiConf_SpiJob_SpiJob_0,SpiConf_SpiJob_SpiJob_1};
