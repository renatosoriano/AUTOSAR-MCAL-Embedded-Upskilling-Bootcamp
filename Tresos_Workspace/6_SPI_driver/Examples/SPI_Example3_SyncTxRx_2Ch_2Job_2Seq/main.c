 ...
 * ***********************************************************************************************************************
 * Example 3. 
 * In this exmple we write/read one single byte to both eeproms, one complete operation at a time for each memory. 
 * For each eeprom we declare its corresponding channel, job and sequence. Notice we set two different external device, 
 * each of them corresponding to one eeprom, with its respective chip selects, but both using the same LPSPI peripheral.
 * ***********************************************************************************************************************
*/
#include "Mcu.h"
#include "Port.h"
