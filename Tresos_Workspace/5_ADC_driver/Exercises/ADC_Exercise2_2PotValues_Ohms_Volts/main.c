 ...
 * ***********************************************************************************************************************
 * Exercise 2. 
 * Display the values of the two potentiometers in Ohms and Volts (since printf does not support floating-point numbers, 
 * adapt the display to simulate the floating-point).
 * ***********************************************************************************************************************
*/
#include "Mcu.h"
#include "Port.h"
...
#include <stdio.h>  // Include the standard I/O library for sprintf
