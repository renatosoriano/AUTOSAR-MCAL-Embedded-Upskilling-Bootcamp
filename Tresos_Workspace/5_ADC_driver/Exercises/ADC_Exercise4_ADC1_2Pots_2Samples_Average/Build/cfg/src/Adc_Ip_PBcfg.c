...
/**
* @brief          ADC Ip List of Channels Configuration for Logical ID 0 corresponding to the ADC1 configuration variant .
*/
...
/**
* @brief          ADC Ip Config for Logical ID 0 corresponding to the ADC1 configuration variant .
*/
