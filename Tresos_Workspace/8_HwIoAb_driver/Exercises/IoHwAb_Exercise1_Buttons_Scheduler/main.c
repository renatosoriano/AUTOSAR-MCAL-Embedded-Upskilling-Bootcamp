 ...
 * main function. Use now an Scheduler where the main function (state machine) is executed in a task every 50ms and the 
 * last event detected for each button (an action executed) runs in another task every 100ms.
 * ***********************************************************************************************************************
*/
