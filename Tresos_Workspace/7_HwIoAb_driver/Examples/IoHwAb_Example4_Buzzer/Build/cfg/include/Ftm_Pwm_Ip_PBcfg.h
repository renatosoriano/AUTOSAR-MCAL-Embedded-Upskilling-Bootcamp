...
*                                          CONSTANTS
==================================================================================================*/
/* Ftm instance index for configuration PwmFtm1Ch7 */
#define FTM_PWM_IP_I1_CH7_CFG      (1U)
...
extern const Ftm_Pwm_Ip_UserCfgType Ftm_Pwm_Ip_UserCfg1;

/* Ftm instance 1 configuration structure */
extern const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_InstCfg1;

/* Ftm instance 1 synchronization configuration structure */
extern const Ftm_Pwm_Ip_SyncCfgType Ftm_Pwm_Ip_SyncCfg1;

/* Channel configurations for Ftm instance 1 */
/* Ftm channel 7 configuration */
extern const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_I1_Ch7;
