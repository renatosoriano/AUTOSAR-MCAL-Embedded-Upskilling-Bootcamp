...
const Ftm_Pwm_Ip_SyncCfgType Ftm_Pwm_Ip_SyncCfg1 =
{
...
const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_InstCfg1 =
{
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_I1_Ch7 =
{
    /* ChannelId */             7U,
...
const Ftm_Pwm_Ip_ChannelConfigType * const Ftm_Pwm_Ip_I1_ChArray[1U] =
{
    &Ftm_Pwm_Ip_I1_Ch7
};

/* Ftm instance 1 User configuration structure */
const Ftm_Pwm_Ip_UserCfgType Ftm_Pwm_Ip_UserCfg1 =
{
    /* InstanceCfg */           &Ftm_Pwm_Ip_InstCfg1,
    /* ConfiguredChArray */     Ftm_Pwm_Ip_I1_ChArray,
    /* NoOfConfiguredCh */      1U
#if (defined(FTM_PWM_IP_HAS_FAULT) && (FTM_PWM_IP_HAS_FAULT == STD_ON))
    ,
