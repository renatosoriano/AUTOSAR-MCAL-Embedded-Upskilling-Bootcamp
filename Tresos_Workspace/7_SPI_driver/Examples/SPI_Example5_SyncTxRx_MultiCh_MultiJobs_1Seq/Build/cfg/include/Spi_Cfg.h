...
*/
#define SpiConf_SpiChannel_SpiChannel_Wren    ((Spi_ChannelType)0)
#define SpiConf_SpiChannel_SpiChannel_Cmd    ((Spi_ChannelType)1)
#define SpiConf_SpiChannel_SpiChannel_Addr    ((Spi_ChannelType)2)
#define SpiConf_SpiChannel_SpiChannel_Data    ((Spi_ChannelType)3)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_SpiJob_Wren   ((Spi_JobType)0)
#define SpiConf_SpiJob_SpiJob_Data   ((Spi_JobType)1)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_Write   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_SpiSequence_Read   ((Spi_SequenceType)1)
