...
*
*/
#define PortConf_PortPin_EEPROM_MOSI  0
#define PortConf_PortPin_EEPROM_MISO  1
#define PortConf_PortPin_EEPROM_CLK  2
#define PortConf_PortPin_EEPROM_CS1  3
#define PortConf_PortPin_EEPROM_CS0  4
