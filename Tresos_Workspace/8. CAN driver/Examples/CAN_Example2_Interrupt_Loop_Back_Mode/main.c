 ...
 * connected to internal Rx signal and everything transmitted will be received in the same CAN module without an external hardware. 
 * The example is configured in interrupt mode meaning the CAN interrupt will be in charge of transmit the 8 bytes of the message.
 * 
