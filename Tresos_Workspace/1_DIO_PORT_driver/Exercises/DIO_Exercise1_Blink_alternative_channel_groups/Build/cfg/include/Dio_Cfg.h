...
/**
* @brief        Symbolic name for the channel group PORTC_1HALF_LEDS.
*
*/

#define DioConf_DioChannelGroup_PORTC_1HALF_LEDS    \
(&DioConfig_aChannelGroupList[0])
/**
* @brief        Symbolic name for the channel group PORTC_2HALF_LEDS.
*
*/

#define DioConf_DioChannelGroup_PORTC_2HALF_LEDS    \
