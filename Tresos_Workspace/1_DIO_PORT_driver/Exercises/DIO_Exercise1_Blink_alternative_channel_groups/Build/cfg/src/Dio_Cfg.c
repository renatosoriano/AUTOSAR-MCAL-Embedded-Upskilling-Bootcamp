...
*/
const Dio_ChannelGroupType DioConfig_aChannelGroupList[2] =
{
    { DioConf_DioPort_PORTC, (uint8)0x08, (Dio_PortLevelType)0x00000f00UL},
    { DioConf_DioPort_PORTC, (uint8)0x0c, (Dio_PortLevelType)0x0000f000UL}
};

/**
* @brief          List of channel groups mapping with partition in configuration DioConfig.
*/
const Dio_ChannelGroupType * const Dio_pxChannelGroupsListForEachPartition[1][2] =
{
    {
    &DioConfig_aChannelGroupList[0],
