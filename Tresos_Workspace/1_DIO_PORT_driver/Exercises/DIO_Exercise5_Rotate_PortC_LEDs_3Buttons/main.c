 ...
 * ***********************************************************************************************************************
 * Exercise 5. 
 * Write a program that rotates an LED on port C, but this time with three speeds and three buttons. 
 * Each button will activate a different speed.
 * ***********************************************************************************************************************
*/
