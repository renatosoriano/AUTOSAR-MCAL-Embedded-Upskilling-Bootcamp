...
const Ftm_Pwm_Ip_ChannelConfigType * const Ftm_Pwm_Ip_I0_ChArray[1U] =
{
    &Ftm_Pwm_Ip_I0_Ch0
};
...
const Ftm_Pwm_Ip_SyncCfgType Ftm_Pwm_Ip_SyncCfg2 =
{
    /* SyncMode */                   FTM_PWM_IP_SYNC_SWTRIGGER,
    /* HwSync0 */                    (boolean)FALSE,
    /* HwSync1 */                    (boolean)FALSE,
...
const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_InstCfg2 =
{
    /* ClkSrc */                FTM_PWM_IP_CLOCK_SOURCE_EXTERNALCLK,
    /* ClkPs */                 FTM_PWM_IP_CLOCK_DIV_128,
    /* AlternateclkPs */        FTM_PWM_IP_CLOCK_DIV_1,
...
/* Ftm channel 0 configuration */
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_I2_Ch0 =
{
    /* ChannelId */             0U,
    /* ChannelMode */           FTM_PWM_IP_MODE_EDGE_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)FALSE,
...
/* Ftm channels configuration array */
const Ftm_Pwm_Ip_ChannelConfigType * const Ftm_Pwm_Ip_I2_ChArray[1U] =
{
    &Ftm_Pwm_Ip_I2_Ch0
};
