...
/**
* @brief          Symbolic name for the channel C8_BIT0.
*
*/
#define  DioConf_DioChannel_C8_BIT0 ((uint16)0x0048U)



/**
* @brief          Symbolic name for the channel C9_BIT1.
*
*/
#define  DioConf_DioChannel_C9_BIT1 ((uint16)0x0049U)
