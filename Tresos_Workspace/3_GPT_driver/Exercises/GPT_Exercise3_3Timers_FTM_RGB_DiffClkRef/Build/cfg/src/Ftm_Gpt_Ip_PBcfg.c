...
const Ftm_Gpt_Ip_InstanceConfigType FTM_2_InitConfig_PB = 
{
    /** @brief Freeze bit */
    (boolean)(FALSE), /**< @brief Freeze Disable */
    /** @brief FTM clock source  */
...
const Ftm_Gpt_Ip_ChannelConfigType FTM_1_ChannelConfig_PB[1U] = 
{
    /** @brief GptFtmChannels_0 */
    {
        /** @brief Ftm Channel Id */
...
const Ftm_Gpt_Ip_ChannelConfigType FTM_2_ChannelConfig_PB[1U] = 
{
    /** @brief GptFtmChannels_0 */
    {
        /** @brief Ftm Channel Id */
