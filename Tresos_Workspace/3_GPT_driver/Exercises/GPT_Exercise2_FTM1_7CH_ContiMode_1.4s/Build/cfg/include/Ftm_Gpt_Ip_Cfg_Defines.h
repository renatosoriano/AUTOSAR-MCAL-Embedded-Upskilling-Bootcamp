...
#define FTM_1_CH_4_CH_5_ISR_USED

#ifndef FTM_1_CH_4_USED
    #define FTM_1_CH_4_USED
#else
    #error "FTM_1_CH_4 cannot be used by GPT. Instance locked by another driver!"
#endif

#ifndef FTM_1_CH_5_USED
    #define FTM_1_CH_5_USED
#else
    #error "FTM_1_CH_5 cannot be used by GPT. Instance locked by another driver!"
#endif
                                                                                                                                                                                                                                                                                                                                                                                                                                                        /* Generate ISR when check in GptHwConfiguration*/
        
#define FTM_1_CH_6_CH_7_ISR_USED

#ifndef FTM_1_CH_6_USED
    #define FTM_1_CH_6_USED
#else
    #error "FTM_1_CH_6 cannot be used by GPT. Instance locked by another driver!"
#endif

#ifndef FTM_1_CH_7_USED
    #define FTM_1_CH_7_USED
#else
    #error "FTM_1_CH_7 cannot be used by GPT. Instance locked by another driver!"
#endif
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            /* Generate ISR when check in GptHwConfiguration*/
                /* Channel per instance*/
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    /* Generate ISR when check in GptHwConfiguration*/
