...
*/
    ...
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_5  (5U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_6  (6U)
