...
extern void Gpt_TimeoutCallback_3(void);
extern void Gpt_TimeoutCallback_4(void);
extern void Gpt_TimeoutCallback_5(void);
extern void Gpt_TimeoutCallback_6(void);
...
#define GPT_CONF_CHANNELS_PB    7U
...
static const uint8 u8GptChannelIdToIndexMap[GPT_NUM_CONFIG] =
{
    ...
    5, /* Logical Channel GptChannelConfiguration_5*/
    6  /* Logical Channel GptChannelConfiguration_6*/
};
...
,
    {   /*GptChannelConfiguration_3 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_TimeoutCallback_3, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
...
,
    {   /*GptChannelConfiguration_4 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_TimeoutCallback_4, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
        (GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        &Gpt_Ipw_ChannelConfig_PB[4U]
    }
,
    {   /*GptChannelConfiguration_5 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_TimeoutCallback_5, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
        (GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        &Gpt_Ipw_ChannelConfig_PB[5U]
    }
,
    {   /*GptChannelConfiguration_6 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_TimeoutCallback_6, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
        (GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        &Gpt_Ipw_ChannelConfig_PB[6U]
    }
};
