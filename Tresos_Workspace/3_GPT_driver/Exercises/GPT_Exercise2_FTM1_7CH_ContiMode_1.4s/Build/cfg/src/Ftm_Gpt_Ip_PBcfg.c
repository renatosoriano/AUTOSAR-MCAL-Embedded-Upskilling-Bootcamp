...
const Ftm_Gpt_Ip_InstanceConfigType FTM_1_InitConfig_PB = 
{
    /** @brief Freeze bit */
...
const Ftm_Gpt_Ip_ChannelConfigType FTM_1_ChannelConfig_PB[7U] = 
{
