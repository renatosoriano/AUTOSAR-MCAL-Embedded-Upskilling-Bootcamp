 ...
 */
Gpt_Ipw_HwChannelConfigType Gpt_Ipw_ChannelConfig_PB[7U] =
{
    ...
    ,
    /** @brief GptChannelConfiguration_2 */
    {
        /** @brief IP type  */
        GPT_FTM_MODULE,
        /** @brief IP instance */
    ...
    ,
    /** @brief GptChannelConfiguration_3 */
    {
        /** @brief IP type  */
        GPT_FTM_MODULE,
        /** @brief IP instance */
    ...
    ,
    /** @brief GptChannelConfiguration_4 */
    {
        /** @brief IP type  */
        GPT_FTM_MODULE,
        /** @brief IP instance */
    ...
    ,
    /** @brief GptChannelConfiguration_5 */
    {
        /** @brief IP type  */
        GPT_FTM_MODULE,
        /** @brief IP instance */
    ...
    ,
    /** @brief GptChannelConfiguration_6 */
    {
        /** @brief IP type  */
        GPT_FTM_MODULE,
        /** @brief IP instance */
