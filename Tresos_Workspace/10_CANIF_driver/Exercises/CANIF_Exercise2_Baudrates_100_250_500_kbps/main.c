 ...
 * ***********************************************************************************************************************
 * Exercise 2. 
 * The following exercise is repeated but this time using the CanIf layer: CAN_Exercise2_Baudrates_100_250_500_kbps.
...
int main( void )
{
    ...
    /* From previous CAN_Exercise2, leaving in comment for quick reference of what's changed and replaced:
