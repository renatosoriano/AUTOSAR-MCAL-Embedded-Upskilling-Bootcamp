...
typedef Std_ReturnType (*CanIf_SetControllerModeFuncPtrType)(uint8 Controller, Can_ControllerStateType Transition);
...
typedef struct
{
    ...
    const CanIf_SetControllerModeFuncPtrType CanSetControllerMode;
